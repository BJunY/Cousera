...
y = new_y;
J = -trace([y 1-y]*[log(out) log(1 - out)]')/m + ...
...
for i = 1:m,
    z1 = [ones(1) X(i,:)]*Theta1';
    a1 = sigmoid(z1);
    z2 = [ones(1) a1]*Theta2';
    out = sigmoid(z2);
    deta3 = out - y(i,:);
    deta2 = Theta2'*deta3'.*[1,((1 - sigmoid(z1)).*sigmoid(z1))]';
    deta2 = deta2(2:end);
    
    Theta1_grad = Theta1_grad + deta2*[1,X(i, :)];
    Theta2_grad = Theta2_grad + deta3'*[1, a1];
end;
